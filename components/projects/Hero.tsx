	...
	return (
		<section className="p-4 md:px-16 lg:max-w-7xl lg:mx-auto py-8 md:py-16 lg:pb-32 w-full h-full">
			<div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-16">
				...
				<Link href={"#upcoming"} className="col-span-1 w-full group overflow-hidden rounded-lg">
					<Image
						src={"/assets/fallback/icon-grid.svg"}
						alt=""
						className="w-full rounded-lg group-hover:scale-105 transition-all duration-300"
						width={100}
						height={100}
					/>
				...
				<Link href={"#ongoing"} className="col-span-1 w-full group overflow-hidden rounded-lg">
					<Image
						src={"/assets/fallback/icon-grid.svg"}
						alt=""
						className="w-full rounded-lg group-hover:scale-105 transition-all duration-300"
				...
				<Link href={"#completed"} className="col-span-1 w-full group overflow-hidden rounded-lg">
					<Image
						src={"/assets/fallback/icon-grid.svg"}
						alt=""
						className="w-full rounded-lg group-hover:scale-105 transition-all duration-300"
