		...
		<section className="w-full p-4 md:px-16 lg:max-w-7xl lg:mx-auto pb-8 md:pb-16 lg:pb-32">
			...
			<section className="w-full max-w-4xl flex justify-center mx-auto h-fit">
				<div className='flex gap-12'>
					<Link href={"https://www.instagram.com/shri_rajayoham_construction"} target='_blank' className='flex text-xs py-4 items-center border-t-2 border-black'>
						<Grid3X3Icon strokeWidth={1.5} size={16} className='mr-1'/>
						<p>POSTS</p>
					</Link>
					<Link href={"https://www.instagram.com/shri_rajayoham_construction"} target='_blank' className='flex text-xs py-4 items-center'>
						<FilmIcon strokeWidth={1.5} size={16} className='mr-1'/>
						<p>REELS</p>
					</Link>
					<Link href={"https://www.instagram.com/shri_rajayoham_construction"} target='_blank' className='flex text-xs py-4 items-center'>
						<BookMarkedIcon strokeWidth={1.5} size={16} className='mr-1'/>
						<p>SAVED</p>
					</Link>
					<Link href={"https://www.instagram.com/shri_rajayoham_construction"} target='_blank' className='flex text-xs py-4 items-center'>
						<UserIcon strokeWidth={1.5} size={16} className='mr-1'/>
						<p>TAGGED</p>
					</Link>
				</div>
			</section>
