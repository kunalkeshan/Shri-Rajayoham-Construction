...
/**
 * Represents a component that displays detailed services offered by Shri Rajayoham Construction Company.
 */
	...
	const services: Array<ServiceType> = [
		{
			...
			content: [
				...
				},
				{
					type: 'paragraph',
					values: [
						'Welcome to Shri Rajayoham Construction Company, your one–stop shop for all your design and drawing needs. We specialize in 2D floor plans, 2D elevation working drawings, and 3D elevation designs. Our team of experienced professionals will work with you to create the perfect design for your project.',
						'At Shri Rajayoham Construction Company, we understand that every project is unique and requires its own set of design requirements. That’s why we offer custom solutions tailored specifically to your needs. Whether you need a simple 2D floor plan or an intricate 3D model, our team is here to help you get the job done right. Contact us today for more information about our services!',
					],
				},
			],
		},
		{
			...
			content: [
				...
				},
				{
					type: 'paragraph',
					values: [
						'At Shri Rajayoham Construction Company, we strive to provide our clients with the highest quality structural designs that are both cost–effective and safe. With our expertise in this field, you can rest assured that your project will be completed on time and within budget. Contact us today for more information about our services!',
					],
				},
			],
		},
			...
			content: [
				{
					type: 'paragraph',
					values: [
						'At Shri Rajayoham Construction Company, we understand the importance of electrical drawings for any construction project. Our team of experienced engineers and technicians are well-versed in creating detailed electrical drawings that meet all safety standards and regulations. We use the latest software to create accurate and precise drawings that are easy to read and understand.',
						...
						'We take pride in our work and strive to ensure that our clients receive the highest quality of service. We are committed to providing timely delivery of our services so that your project can be completed on time and within budget. With Shri Rajayoham Construction Company, you can rest assured that your electrical drawing needs will be met with precision and accuracy.',
					],
				},
			],
		},
			...
			content: [
				{
					...
					values: [
						...
						'For quality doors and windows at an affordable price, trust Shri Rajayoham Construction Company! Contact us today to learn more about how we can help you create the perfect look for your space.',
					],
				},
			],
		},
		...
		},
		{
			...
			content: [
				...
				},
				{
					type: 'paragraph',
					values: [
						'Are you looking for a reliable and experienced team to install windows in your home or office? Look no further than Shri Rajayoham Construction Company! We are a leading construction company that specializes in window installation. Our team of experienced professionals have years of experience in the industry and can provide you with the highest quality window installation services. ',
			...
			content: [
				...
				},
				{
					...
					values: [
						...
						'Both services are designed to make life easier for you, while also helping you save money on energy bills in the long run. At Shri Rajayoham Construction Company, we strive to provide our customers with top–notch service and quality workmanship. We take pride in our ability to deliver projects on time and within budget, so you can rest assured that your project will be completed according to your specifications. Contact us today for more information about our terrace parapet wall upto 3Ft Height as per Elevation Design services or any other turnkey services we offer!',
					],
				},
			],
		},
		...
		<section className='w-full'>
			<div className='w-full p-4 md:px-16 lg:max-w-7xl lg:mx-auto pt-8 md:pt-16 lg:pt-32'>
				<Tabs defaultValue={services[0].value}>
					<TabsList
						className='h-fit w-full flex flex-wrap bg-app-secondary justify-center gap-4'
